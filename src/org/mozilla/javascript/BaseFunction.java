...
// #/string_id_map#
        ...
        switch (id) {
            ...
            case Id_caller:
                ...
                break;
            case Id_prototype:
                // some functions such as built-ins don't have a prototype
                // property
    ...
    public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope,
        ...
        switch (id) {
            ...
            case Id_bind:
                ...
                if (argc > 0) {
                    boundThis = ScriptRuntime.toObjectOrNull(cx, args[0],
                            scope);
                ...
                return new BoundFunction(cx, scope, targetFunction,
                        boundThis, boundArgs);
        }
        throw new IllegalArgumentException(String.valueOf(id));
    }
